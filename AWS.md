...
- ゲートウェイエンドポイント(S3, DynamoDBのみ)と、インターフェイスエンドポイントがある。
  - インターフェースエンドポイントをPrivateLinkを利用。実質PrivateLink。
####### Endpoint Service
####### NAT Gateway
####### Peering
- VPC Peering
...
****** CloudWatch Agent
******* 設定ファイル / config.json
- [[https://docs.aws.amazon.com/ja_jp/AmazonCloudWatch/latest/monitoring/Install-CloudWatch-Agent.html][CloudWatch エージェントを使用して Amazon EC2 インスタンスとオンプレミスサーバーからメトリクスとログを収集する - aws]]
- [[https://docs.aws.amazon.com/ja_jp/AmazonCloudWatch/latest/monitoring/create-cloudwatch-agent-configuration-file.html][CloudWatch エージェント設定ファイルを作成する - aws]]
  - 設定ファイルconfig.json
    Linux : /opt/aws/amazon-cloudwatch-agent/bin/
******** Agentセクション
******** Metricsセクション
******** 
******* amazon-cloudwatch-agent.toml / json
- https://qiita.com/swiftman/items/705e75349f5f0a9f7d51
**** AWS Auto Scaling
**** CloudFormation
=======
#### AWS Auto Scaling
#### CloudFormation
>>>>>>> da64b3e6149158f439ef4f2f452104987db5f3cf:AWS.md
